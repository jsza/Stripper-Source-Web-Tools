...
},{"./ExecutionEnvironment":"/home/jayess/code/stripper_source-tools/node_modules/react/lib/ExecutionEnvironment.js","./createArrayFrom":"/home/jayess/code/stripper_source-tools/node_modules/react/lib/createArrayFrom.js","./getMarkupWrap":"/home/jayess/code/stripper_source-tools/node_modules/react/lib/getMarkupWrap.js","./invariant":"/home/jayess/code/stripper_source-tools/node_modules/react/lib/invariant.js","_process":"/home/jayess/code/stripper_source-tools/node_modules/watchify/node_modules/browserify/node_modules/process/browser.js"}],"/home/jayess/code/stripper_source-tools/node_modules/react/lib/dangerousStyleValue.js":[function(require,module,exports){
/**
 * Copyright 2013-2014, Facebook, Inc.
 * All rights reserved.
 *
...
},{}],"/home/jayess/code/stripper_source-tools/src/BSPParserApp.cjsx":[function(require,module,exports){
var BSPParserApp, React;

React = require('react');

BSPParserApp = React.createClass({
  render: function() {
    return React.createElement("div", null, React.createElement("h3", null, "BSP Entity Parser"));
  }
});
...
},{"react":"/home/jayess/code/stripper_source-tools/node_modules/react/react.js"}],"/home/jayess/code/stripper_source-tools/src/Box.cjsx":[function(require,module,exports){
...
mapToVector = function(s) {
  return s.split(' ').map(function(thing) {
    return parseFloat(thing);
  });
};

makeBeam = function(targetname, start, end, width, color, texture) {
...
makeTarget = function(targetname, origin) {
  return {
...
addVectors = function(v1, v2) {
  return v1.map(function(a, i) {
    return a + v2[i];
  });
};

Box = (function() {
  Box.prototype.defaultWidth = 4.0;

  Box.prototype.defaultTexture = 'materials/effects/blueblacklargebeam.vmt';

  Box.prototype.defaultColor = '255 0 0';

  function Box(identifier, origin, size, width, color, texture) {
  ...
  Box.prototype.renderStripperCode = function() {
    var b, c, end, k, result, start, v, _i, _len, _ref;
    result = [];
    c = this.getCorners();
    for (k in c) {
      v = c[k];
    ...
    b = [['t1', 't2'], ['t2', 't3'], ['t3', 't4'], ['t4', 't1'], ['b1', 'b2'], ['b2', 'b3'], ['b3', 'b4'], ['b4', 'b1'], ['t1', 'b1'], ['t2', 'b2'], ['t3', 'b3'], ['t4', 'b4']];
    for (_i = 0, _len = b.length; _i < _len; _i++) {
      _ref = b[_i], start = _ref[0], end = _ref[1];
      result.push(this.makeBeam(start, end));
    }
    return result.map(objectToStripper).join('\n');
  };

  Box.prototype.makeBeam = function(start, end) {
    return makeBeam(this.identifier + 'beam' + start + end, this.identifier + start, this.identifier + end, this.width, this.color, this.texture);
  };
...
},{}],"/home/jayess/code/stripper_source-tools/src/CoolInput.cjsx":[function(require,module,exports){
var CoolInput, React;
...
},{"react":"/home/jayess/code/stripper_source-tools/node_modules/react/react.js"}],"/home/jayess/code/stripper_source-tools/src/LaserBoxApp.cjsx":[function(require,module,exports){
...
},{"./Box":"/home/jayess/code/stripper_source-tools/src/Box.cjsx","./CoolInput":"/home/jayess/code/stripper_source-tools/src/CoolInput.cjsx","codemirror":"/home/jayess/code/stripper_source-tools/node_modules/codemirror/lib/codemirror.js","react":"/home/jayess/code/stripper_source-tools/node_modules/react/react.js","react/lib/LinkedStateMixin":"/home/jayess/code/stripper_source-tools/node_modules/react/lib/LinkedStateMixin.js"}],"/home/jayess/code/stripper_source-tools":[function(require,module,exports){
var BSPParserApp, LaserBoxApp, React;
...
},{"./BSPParserApp":"/home/jayess/code/stripper_source-tools/src/BSPParserApp.cjsx","./LaserBoxApp":"/home/jayess/code/stripper_source-tools/src/LaserBoxApp.cjsx","react":"/home/jayess/code/stripper_source-tools/node_modules/react/react.js"}]},{},["/home/jayess/code/stripper_source-tools"]);
